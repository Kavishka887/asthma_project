...
class viewMedicine extends StatefulWidget {
  const viewMedicine({Key? key}) : super(key: key);
                          ...
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: GestureDetector(
                                onTap: (){
                                  Get.to(()=>moreDetails(content: userSnapshot[index]["medicineDescription"], title: userSnapshot[index]["medicineName"], imageUrl: userSnapshot[index]["medicinePhoto"]));
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(userSnapshot[index]["medicineName"],
                                          style: GoogleFonts.montserrat(
                                              fontSize: 11.sp,
                                      ...
                                      Padding(
                                        ...
                                        child: Text(userSnapshot[index]["medicineDescription"].toString().substring(0,10) + " . . .",
                                          style: GoogleFonts.montserrat(
                                              fontSize: 10.sp,
